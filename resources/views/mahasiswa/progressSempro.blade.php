...
@section('title', 'Progress Sempro')
@section('content')

<div class="container mt-5">
    <h2 class="fs-1">Progress Seminar Proposal</h2>
</div>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th scope="col" class="col-sm-2">Hasil Uji</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="col-sm-2">
                    <a href="hasiluji/{{ $s->id }}" class="btn btn-primary">Lihat Hasil Uji</a>
                </td>
                <td class="col-sm-2">
                    <a href="jadwalsempro/{{ $s->id }}" class="btn btn-primary">Jadwal</a>
                </td>
                <td class="col-sm-2">
                    <a href="berkassempro/{{ $s->id }}/upload" class="btn btn-primary">Edit</a>
                </td>
            </tr>
            @endforeach
        </tbody>
