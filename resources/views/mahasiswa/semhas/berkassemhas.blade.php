...
@section('title', 'Berkas Semhas')
@section('content')

<div class="container mt-5">
    <h2 class="fs-1">Upload Berkas Seminar Hasil</h2>
</div>

<!-- Sale & Revenue Start -->
<form class="form-horizontal" action="uploadsemhasfix" method="post" enctype="multipart/form-data">
{{ csrf_field() }}
    ...
    <table class="table table-sm table-borderless fs-5">
        <tbody>
            ...
            <tr>
                ...
                <td>:&nbsp;
                    <input type="file" name="berkas_semhas" value="" required> 
                </td>
            </tr>
        </tbody>
    </table>
