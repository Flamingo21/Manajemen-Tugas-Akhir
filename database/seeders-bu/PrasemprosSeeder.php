...
class PrasemprosSeeder extends Seeder
{
    ...
    public function run()
    {
        \DB::select('call buatPrasempro(?,?,?,?)', array("211402101", "Animasi", "Perancangan Animasi 3 Dimensi Alur Pengurusan Administrasi Pasien Uumum", "mahasiswa"));


        \DB::select('call buatPrasempro(?,?,?,?)', array("211402102", "Database", "Pembuatan database untuk penyimpanan data polisi sektor", "dosen"));


        \DB::select('call buatPrasempro(?,?,?,?)', array("211402103", "Viritual Reality", "Penerapan Viritual Reality untuk mengobati pasien gangguan jiwa", "bersama"));
