...
@section('title', 'Jadwal Semhas')
@section('content')

<div class="container mt-5">
    <h2 class="fs-1">Jadwal Seminar Hasil</h2>
</div>

<!-- Sale & Revenue Start -->
<div class="container bg-light shadow mt-5 py-5 px-5">
    <div class="d-flex justify-content-end me-3 mb-4">
        <a href="/staff/buatsemhasbaru" class="btn btn-primary">Buat Seminar</a>
    </div>
<table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="col-sm-1">
                    <a href="jadwalsemhas/{{ $s->id }}/mhs" class="btn btn-primary">Mahasiswa</a>
                </td>
                <td class="col-sm-1">
                    <a href="jadwalsemhas/{{ $s->id }}/ubah" class="btn btn-primary">Edit</a>
                </td>
                <td class="col-sm-2">
                    <a href="cetak_jadwalsemhas/{{ $s->id }}" class='btn btn-primary' target="_blank">Download Berkas</a>
                </td>
            </tr>
            @endforeach
        </tbody>
